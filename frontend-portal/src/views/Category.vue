...
async function addCart(product) {
  ...
  try {
    await request.post("/api/portal/cart", { productId: product.id, quantity: 1 });
    showToast("已加入购物车");
  } catch (error) {
