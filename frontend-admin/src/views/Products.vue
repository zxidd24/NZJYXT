...
async function load() {
  ...
  try {
    const [productData, categoryData] = await Promise.all([
      fetchPage((params) => request.get("/api/admin/product/page", { params: { ...filters, ...params } })),
